...
endtask
    ...
    initial begin
        ...
        send_input(16'd4, 8'b00001000); // MS3
        send_input(16'd5, 8'b00010000); // MS4
        send_input(16'd6, 8'b00100000); // MS5
        send_input(16'd7, 8'b01000000); // MS6
        ...
        send_input(16'd0, 8'b00100010); // MS1 and MS5
        send_input(16'd0, 8'b01000100); // MS2 and MS6
        send_input(16'd0, 8'b10001000); // MS3 and MS7
        
        // col 2 [ 0 1 0 0] to row 1 and row 2
        send_input(16'd0, 8'b00010001); // MS0 and MS4
        send_input(16'd1, 8'b00100010); // MS1 and MS5
        send_input(16'd0, 8'b01000100); // MS2 and MS6
        send_input(16'd0, 8'b10001000); // MS3 and MS7
        
        // col 3 [ 0 0 1 0 ] to row 1 and row 2
        send_input(16'd0, 8'b00010001); // MS0 and MS4
        send_input(16'd0, 8'b00100010); // MS1 and MS5
        send_input(16'd1, 8'b01000100); // MS2 and MS6
        send_input(16'd0, 8'b10001000); // MS3 and MS7
        
        // col 4 [0 0 0 1] to row 1 qnd row 2
        send_input(16'd0, 8'b00010001); // MS0 and MS4
        send_input(16'd0, 8'b00100010); // MS1 and MS5
        send_input(16'd0, 8'b01000100); // MS2 and MS6
        ...
        @(posedge CLK);
         ...
         // load statinoary data
        send_input(16'd9, 8'b00000001); // MS0
        send_input(16'd10, 8'b00000010); // MS1
        send_input(16'd11, 8'b00000100); // MS2
        send_input(16'd12, 8'b00001000); // MS3
        send_input(16'd13, 8'b00010000); // MS4
        send_input(16'd14, 8'b00100000); // MS5
        send_input(16'd15, 8'b01000000); // MS6
        send_input(16'd16, 8'b10000000); // MS7
        wait(isEmpty==1'b1);
        ...
        // multicast data
        // col 1 [ 1 0 0 0] multicast to row 1 and row 2
        send_input(16'd1, 8'b00010001); // MS0 and MS4
        send_input(16'd0, 8'b00100010); // MS1 and MS5
        send_input(16'd0, 8'b01000100); // MS2 and MS6
        send_input(16'd0, 8'b10001000); // MS3 and MS7
