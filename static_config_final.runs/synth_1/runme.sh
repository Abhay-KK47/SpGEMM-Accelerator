...
HD_PWD='/home/avinash/static_config_final/static_config_final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log maeriAccelerator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source maeriAccelerator.tcl
